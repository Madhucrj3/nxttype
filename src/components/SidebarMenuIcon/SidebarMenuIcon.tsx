...
import { SidebarIcon, Sidespan } from './SiderbarMenuIconStyledComp';
...
const SidebarMenuIcon = inject('globalStore')(observer((props:SidebarMenuIconProps) => {
  ...
  return (
    <SidebarIcon activeStatus={isActive} themed={theme.themes} onClick={handlesideicon}>
        <FontAwesomeIcon icon={icons} style={{color:isActive ?"red":(theme.themes===LIGHT?'#000':'#fff')}}/>
